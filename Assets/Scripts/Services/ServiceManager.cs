...
using UnityEngine;
using Semaphore = General.Semaphore;
...
public static class ServiceManager {
    ...
    public static async UniTask<T> GetService<T>(CancellationToken c = default) {
        var type = typeof(T);
    ...
    public static async UniTask RegisterService<T, U>(U service) where U : IService, T {
